# Ultralytics 🚀 AGPL-3.0 License - https://ultralytics.com/licens
import gc
import math
import os
import random
...
def get_cpu_info():
    ...
    from yolo12.utils import PERSISTENT_CACHE  # avoid circular import error
...
def strip_optimizer(f: Union[str, Path] = "best.pt", s: str = "", updates: dict = None) -> dict:
    ...
    Examples:
        >>> from pathlib import Path
        >>> from yolo12.utils.torch_utils import strip_optimizer
...
def profile(input, ops, n=10, device=None, max_num_obj=0):
    ...
    Examples:
        >>> from yolo12.utils.torch_utils import profile
