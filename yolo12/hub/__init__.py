...
from yolo12.hub.auth import Auth
from yolo12.hub.session import HUBTrainingSession
from yolo12.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, events
from yolo12.utils import LOGGER, SETTINGS, checks
...
def check_dataset(path: str, task: str) -> None:
    ...
    Examples:
        >>> from yolo12.hub import check_dataset
