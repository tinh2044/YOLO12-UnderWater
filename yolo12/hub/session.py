...
from yolo12.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX, TQDM
from yolo12.utils import IS_COLAB, LOGGER, SETTINGS, __version__, checks, emojis
from yolo12.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (Dict): Model data fetched from yolo12 HUB.
    ...
    def load_model(self, model_id):
        """
        Load an existing model from yolo12 HUB using the provided model identifier.
