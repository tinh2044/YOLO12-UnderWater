...
from yolo12.data.utils import polygons2masks, polygons2masks_overlap
from yolo12.utils import LOGGER, colorstr
from yolo12.utils.checks import check_version
from yolo12.utils.instance import Instances
from yolo12.utils.metrics import bbox_ioa
from yolo12.utils.ops import segment2box, xyxyxyxy2xywhr
from yolo12.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from yolo12.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from yolo12.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from yolo12.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from yolo12.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            # lut_hue = ((x * (r[0] + 1)) % 180).astype(dtype)   # original hue implementation from yolo12<=8.3.78
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from yolo12.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from yolo12.data.dataset import YOLODataset
        >>> from yolo12.utils import IterableSimpleNamespace
