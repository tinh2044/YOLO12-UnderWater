...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Examples:
        >>> from yolo12.utils.checks import parse_requirements
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Examples:
        >>> from yolo12.utils.checks import check_requirements
...
def check_yolo(verbose=True, device=""):
    ...
    from yolo12.utils.torch_utils import select_device
...
def collect_system_info():
    ...
    from yolo12.utils import ENVIRONMENT  # scope to avoid circular import
    from yolo12.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> from yolo12.utils.checks import check_amp
        >>> model = YOLO("yolo11n.pt").model.cuda()
        >>> check_amp(model)
    """
    from yolo12.utils.torch_utils import autocast
