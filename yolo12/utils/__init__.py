...
from yolo12.utils.patches import imread, imshow, imwrite, torch_load, torch_save  # for patches
...
class ThreadingLocked:
    ...
    Examples:
        >>> from yolo12.utils import ThreadingLocked
        >>> @ThreadingLocked()
        >>> def my_function():
        ...    # Your code here
    """
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from yolo12.utils.torch_utils import torch_distributed_zero_first
