...
from yolo12.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Examples:
        >>> from yolo12.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Examples:
        >>> from yolo12.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Examples:
        >>> from yolo12.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Examples:
        >>> from yolo12.utils.downloads import get_google_drive_file_info
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.3.0", **kwargs):
    ...
    """
    from yolo12.utils import SETTINGS  # scoped for circular import
