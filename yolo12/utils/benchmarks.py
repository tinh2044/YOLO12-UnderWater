...
Usage:
    from yolo12.utils.benchmarks import ProfileModels, benchmark
...
from yolo12 import YOLO, YOLOWorld
from yolo12.cfg import TASK2DATA, TASK2METRIC
from yolo12.engine.exporter import export_formats
from yolo12.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from yolo12.utils.checks import IS_PYTHON_3_12, check_imgsz, check_requirements, check_yolo, is_rockchip
from yolo12.utils.downloads import safe_download
from yolo12.utils.files import file_size
from yolo12.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    Examples:
        ...
        >>> from yolo12.utils.benchmarks import benchmark
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> from yolo12.utils.benchmarks import ProfileModels
