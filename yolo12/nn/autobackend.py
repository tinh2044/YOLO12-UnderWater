...
from yolo12.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from yolo12.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from yolo12.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from yolo12.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from yolo12.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from yolo12.utils.triton import TritonRemoteModel
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                ...
                # from yolo12.utils.ops import xywh2xyxy
