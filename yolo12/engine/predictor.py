...
from yolo12.data import load_inference_source
from yolo12.data.augment import LetterBox, classify_transforms
from yolo12.nn.autobackend import AutoBackend
from yolo12.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from yolo12.utils.checks import check_imgsz, check_imshow
from yolo12.utils.files import increment_path
from yolo12.utils.torch_utils import select_device, smart_inference_mode
