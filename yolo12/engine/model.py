...
from yolo12.cfg import TASK2DATA, get_cfg, get_save_dir
from yolo12.engine.results import Results
from yolo12.hub import HUB_WEB_ROOT, HUBTrainingSession
from yolo12.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            model (str | Path): Path or name of the model to load or create. Can be a local file path, a
                model name from yolo12 HUB, or a Triton Server model.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        from yolo12 import __version__
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from yolo12.trackers import register_tracker
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from yolo12.utils.tuner import run_ray_tune
    ...
    def names(self) -> Dict[int, str]:
        ...
        """
        from yolo12.nn.autobackend import check_class_names
