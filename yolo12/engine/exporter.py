...
from yolo12.cfg import TASK2DATA, get_cfg
from yolo12.data import build_dataloader
from yolo12.data.dataset import YOLODataset
from yolo12.data.utils import check_cls_dataset, check_det_dataset
from yolo12.nn.autobackend import check_class_names, default_class_names
from yolo12.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from yolo12.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from yolo12.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_COLAB,
    IS_JETSON,
...
from yolo12.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from yolo12.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from yolo12.utils.files import file_size, spaces_in_path
from yolo12.utils.ops import Profile, nms_rotated, xywh2xyxy
from yolo12.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from yolo12.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from yolo12.utils.tal import make_anchors
